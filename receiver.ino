...
myGLCD.print ("THERMOMETER V_0.1",CENTER, 190 ); 
...
int a2 = string2.toInt();
 ...
 if(a2 > 25) alarmBlink();
 if((a2<=25) && (st==1)) tempValue();
 if((a2<=25) && (st==2)) tempScreen();
}
...
myGLCD.print ("OUTSIDE",5, 20 );
myGLCD.print ("TEMPERATURE:",5, 40 );
//myGLCD.setBackColor ( VGA_LIME ); 
myGLCD.print ("GREENHOUSE",5,100 );
myGLCD.print ("TEMPERATURE:",5,120 );
//myGLCD.setColor ( 255, 255, 255 );
//myGLCD.setBackColor ( VGA_OLIVE );
myGLCD.print ("GROUND",5, 180 );
myGLCD.print ("TEMPERATURE:",5, 200 );
...
myGLCD.print ( string1, 220, 15 ) ;
myGLCD.print ( string2, 220, 95 ) ;
